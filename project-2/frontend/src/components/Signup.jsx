...
const Signup = () => {
    const [formData, setFormData] = useState({
      ...
      const isPasswordsMatch = (formData.createPassword === formData.confirmPassword) && (formData.confirmPassword.length>0);
      ...
      const handleChange = (e) => {
        ...
        const handleSubmit = (e) => {
            ...
            }) //The correct syntax for sending data in the request body using axios is to pass an object with the data.
        ...
        const buttonStyle = {
            backgroundColor: isPasswordsMatch ? '#3498db' : '#2c3e50',
            cursor: isPasswordsMatch ? 'pointer' : 'not-allowed',
          };
